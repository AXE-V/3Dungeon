...
export const BtnUpload: FC<SVGComponent> = ({style}) => {
  ...
  return ( 
     <svg 
      ...
      <line x1="71.54" y1="1.53" x2="97.3" y2="1.53" fill="none" stroke="#4d4d4d" strokeMiterlimit="10" opacity="0.25" />
      <line x1="99.06" y1="1.53" x2="106.1" y2="1.53" fill="none" stroke="#4d4d4d" strokeMiterlimit="10" opacity="0.5" />
      <line x1="107.95" y1="1.53" x2="114.99" y2="1.53" fill="none" stroke="#4d4d4d" strokeMiterlimit="10"
        opacity="0.25" />
      <line x1="117.14" y1="1.53" x2="124.18" y2="1.53" fill="none" stroke="#4d4d4d" strokeMiterlimit="10"
        opacity="0.1" />
