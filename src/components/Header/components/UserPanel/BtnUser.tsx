...
export const BtnUser: FC<SVGComponent> = ({style}) => {
  ...
  function onClick<E extends SyntheticEvent<EventTarget>>(e: E) {
    session ? navigate('/user/:id') : navigate('/auth/login')
  }
  ...
  function onMouseLeaveMenu<E extends SyntheticEvent<EventTarget>>(e: E) {    
    setvisible(false)
  }

  function onMouseOverMenu<E extends SyntheticEvent<EventTarget>>(e: E) {  
    setvisible(true)
  }
